...
class KafkaConsumerService:
    ...
    def __init__(self, topic="fraud_transactions", kafka_broker="kafka:9092"):
        print("Conectando a Kafka en:", kafka_broker)
        self.kafka_conf = {
    ...
    def consume_loop(self):
        ...
        while self.consuming:
            try:
                ...
                prediction_result = get_prediction(transaction, self.model)
...
def check_mlflow():
    try:
        response = requests.get("http://mlflow:8080/")
